    ...
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, int index) {
          var productFab = jsonDecode(favoriteController.favoriteList[index].product!);
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        kHeightBox10,
                        Text(
                          OthersMethod.productPriceCalculate(productFab).toString(),
                              ...
                              return IconButtons(
                                ...
                                onPress: () async{
                                  if (productFab.manageStock ?? false) {
                                    int cartQuantity = cartController.cartItemQuantity(productFab.id ?? 0);
                                    log('$cartQuantity');
                                    if (cartQuantity < productFab.stockQuantity) {
                                      if (OthersMethod.variationsIsEmptyCheck(productFab)) {
                                        //added variation + cart
                                        await OthersMethod.variationsSelected(productFab);
                                        cartController.addToCart(productFab,
                                          price: OthersMethod.productPriceCalculate(productFab),
                                          quantity: 1,
                                          brand: OthersMethod.selectedBrands(productFab),
