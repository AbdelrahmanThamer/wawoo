...
class CheckoutController extends GetxController {
  ...
  final List<Map<String, String>> paymentGatewayList = [
    ...
    {"id": "ppcp-gateway", "title": "PayPal", "image": Images.paypal},
    {
      "id": "paystack",
  ...
  Future<void> createOrderFromServer(
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      } else if (_paymentMethod == 'ppcp-gateway') {
        showCustomSnackBar(
            'Your order place Successfully. Please payment process complete then exit app.',
            isError: false);
  ...
  Future<void> makePaypalPayment({
    required BuildContext context,
    required String amount,
    required CreateOrder order,
  }) async {
    if (kPaypalClientId.isEmpty) {
      showCustomSnackBar('Your Paypal client id hare');
      return;
    } else if (kPaypalSecretKey.isEmpty) {
      showCustomSnackBar('Your Paypal secret key hare');
      return;
    }
      ...
      MaterialPageRoute(
        builder: (BuildContext context) => UsePaypal(
          ...
          transactions: [
            {
              "amount": {
                ...
                "details": {
                  ...
                  "shipping_discount": _discountPrice
                }
              },
          ...
          onError: (error) {
            ...
            //showCustomSnackBar('payment error: please make payment again order details', );
          },
          onCancel: (params) {
